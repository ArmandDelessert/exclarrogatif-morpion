...
Le graphe complet au format DOT et SVG est inclus dans le dépôt. Les nœuds du SVG sont cliquables et mènent vers les vidéos YouTube correspondantes.
...
> **Note** : les vidéos `5v00E4RE9Cw` et `W6-ZZ0vtgnc` portent toutes deux l’indice 50/V (probablement un oubli de modification du tableau entre les 2 vidéos). 8 vidéos du graphe ne contiennent aucun code sur le tableau (`58X2c66QxPs`, `65tS5PY8LdU`, `9J3nwusXamY`, `RyvWYc7Fp-U`, `tXYhgZ_rXs8`, `UnDjokbZjbs`, `zAy6U8A7kBo`, `ZFCxZMLZrpA`).
